  ...
  return (
    <div className="p-6 flex flex-col gap-6 animate-in fade-in duration-500 relative">
      ...
      <div className="flex items-center justify-between">
        ...
        {clinicalAttention?.id_episodio && (<div className="text-white/60 text-sm font-mono bg-white/5 px-3 py-1 rounded-md border border-white/10">
          ID Episodio:{" "}
  ...
  <h3 className="text-sm text-white/60 font-semibold uppercase tracking-wide">
    Triage
        ...
        {parsed?.triage ? (
          ...
          <p className="text-white/40 mt-2">No registrado</p>
        )}
      </div>
