...
export default function DeleteInsuranceCompanyModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white border border-health-border rounded-2xl p-6 w-full max-w-md shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-300">
        <h2 className="text-xl font-semibold text-red-600 mb-4">
          Confirmar eliminación
        </h2>

        <p className="text-health-text mb-6 leading-relaxed">
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg bg-red-600 text-white hover:bg-red-700 transition shadow-lg shadow-red-600/20"
          >
            Eliminar
          </button>
        </div>
